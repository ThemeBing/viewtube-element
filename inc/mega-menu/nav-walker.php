...
function viewtube_font_awesome_icon_custom_field( $item_id, $item ) {
    ...
    <p class="description description-wide">
        <label>
            ...
            <select id="edit-menu-item-icon-<?php echo $item_id; ?>" class="widefat" name="menu-item-icon[<?php echo $item_id; ?>]">
                <option value="0"><?php echo esc_html__( 'None', 'bikestore') ?></option>
                <?php

                $icons = fa_icons();
                foreach ($icons as $key => $icon) { ?>                    
                    <option <?php if ($item->font_awesome_icon == $key ) {echo 'selected'; } ?> value="<?php echo esc_attr($key) ?>"><?php echo esc_html( $icon ) ?></option>
                <?php } ?>
            </select>
        </label>
    </p>
